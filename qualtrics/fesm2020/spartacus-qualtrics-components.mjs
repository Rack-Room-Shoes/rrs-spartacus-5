...
import { Component, isDevMode, PLATFORM_ID, Injectable, Inject, NgModule } from '@angular/core';
...
QualtricsEmbeddedFeedbackComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: QualtricsEmbeddedFeedbackComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
QualtricsEmbeddedFeedbackComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.2.3", type: QualtricsEmbeddedFeedbackComponent, selector: "cx-qualtrics-embedded-feedback", ngImport: i0, template: '', isInline: true });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: QualtricsEmbeddedFeedbackComponent, decorators: [{
            type: Component,
            args: [{
...
QualtricsComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: QualtricsComponent, deps: [{ token: QualtricsLoaderService }, { token: QualtricsConfig }], target: i0.ɵɵFactoryTarget.Component });
