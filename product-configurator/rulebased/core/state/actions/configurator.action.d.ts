...
export declare class CreateConfiguration extends StateUtils.EntityLoadAction {
    payload: CommonConfigurator.Owner;
    readonly type = "[Configurator] Create Configuration";
    constructor(payload: CommonConfigurator.Owner);
}
