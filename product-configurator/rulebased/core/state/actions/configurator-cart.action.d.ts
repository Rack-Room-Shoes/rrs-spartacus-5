...
export declare type ConfiguratorCartAction = AddNextOwner | SetNextOwnerCartEntry | ReadCartEntryConfiguration | ReadCartEntryConfigurationSuccess | ReadCartEntryConfigurationFail | ReadOrderEntryConfiguration | ReadOrderEntryConfigurationSuccess | ReadOrderEntryConfigurationFail | RemoveCartBoundConfigurations | UpdateCartEntry;
