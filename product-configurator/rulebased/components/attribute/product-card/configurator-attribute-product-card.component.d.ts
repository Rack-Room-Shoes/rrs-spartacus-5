...
export declare class ConfiguratorAttributeProductCardComponent extends ConfiguratorAttributeBaseComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ConfiguratorAttributeProductCardComponent, "cx-configurator-attribute-product-card", never, { "productCardOptions": "productCardOptions"; }, { "handleDeselect": "handleDeselect"; "handleQuantity": "handleQuantity"; "handleSelect": "handleSelect"; }, never, never, false>;
}
