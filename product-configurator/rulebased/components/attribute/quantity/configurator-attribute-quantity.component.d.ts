...
export declare class ConfiguratorAttributeQuantityComponent implements OnDestroy, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ConfiguratorAttributeQuantityComponent, "cx-configurator-attribute-quantity", never, { "quantityOptions": "quantityOptions"; }, { "changeQuantity": "changeQuantity"; }, never, never, false>;
}
