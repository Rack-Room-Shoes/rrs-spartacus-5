...
import { provideDefaultConfigFactory, provideDefaultConfig, RoutingModule } from '@spartacus/core';
import { CommonModule } from '@angular/common';
import * as i2 from '@angular/router';
import { RouterModule } from '@angular/router';
import { CommonConfiguratorModule } from '@spartacus/product-configurator/common';
import { CmsRouteModule, PageLayoutComponent, CmsPageGuard } from '@spartacus/storefront';
...
TextfieldConfiguratorRoutingModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorRoutingModule, imports: [RoutingModule.forRoot(), CmsRouteModule] });
