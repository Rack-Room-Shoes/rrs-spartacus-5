...
import { Injectable, Component, ChangeDetectionStrategy, Input, EventEmitter, Output, NgModule, InjectionToken } from '@angular/core';
...
import { StateUtils, OCC_USER_ID_CURRENT, I18nModule, UrlModule, provideDefaultConfig, normalizeHttpError, StateModule, ConfigModule } from '@spartacus/core';
import { tap, map, filter, take, switchMap, switchMapTo, catchError } from 'rxjs/operators';
...
class ConfiguratorTextfieldService {
    ...
    createConfiguration(owner) {
        ...
        map((configuration) => configuration !== null && configuration !== void 0 ? configuration : {
            configurationInfos: [],
    ...
    readConfigurationForCartEntry(owner) {
        return this.activeCartService.requireLoadedCart().pipe(switchMap((cart) => this.userIdService
            ...
            owner: owner,
        })), tap((readFromCartEntryParameters) => this.store.dispatch(new ReadCartEntryConfiguration(readFromCartEntryParameters))), switchMapTo(this.store.pipe(select(getConfigurationContent))), filter((configuration) => !this.isConfigurationInitial(configuration)), 
    ...
    readConfigurationForOrderEntry(owner) {
        ...
        return this.store.pipe(select(getConfigurationContent), filter((configuration) => !this.isConfigurationInitial(configuration)), map((configuration) => configuration
            ? configuration
            : {
                configurationInfos: [],
                owner: ConfiguratorModelUtils.createInitialOwner(),
...
ConfiguratorTextfieldService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ConfiguratorTextfieldService, deps: [{ token: i1.Store }, { token: i2.ActiveCartFacade }, { token: i3.CommonConfiguratorUtilsService }, { token: i2$1.UserIdService }], target: i0.ɵɵFactoryTarget.Injectable });
...
ConfiguratorTextfieldAddToCartButtonComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ConfiguratorTextfieldAddToCartButtonComponent, deps: [{ token: ConfiguratorTextfieldService }], target: i0.ɵɵFactoryTarget.Component });
ConfiguratorTextfieldAddToCartButtonComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.2.3", type: ConfiguratorTextfieldAddToCartButtonComponent, selector: "cx-configurator-textfield-add-to-cart-button", inputs: { configuration: "configuration", productCode: "productCode" }, ngImport: i0, template: "<button\n  class=\"cx-btn btn btn-block btn-primary cx-add-to-cart-btn\"\n  [routerLink]=\"{ cxRoute: 'cart' } | cxUrl\"\n  (click)=\"onAddToCart()\"\n>\n  {{ getButtonText() | cxTranslate }}\n</button>\n", dependencies: [{ kind: "directive", type: i2$2.RouterLink, selector: ":not(a):not(area)[routerLink]", inputs: ["queryParams", "fragment", "queryParamsHandling", "state", "relativeTo", "preserveFragment", "skipLocationChange", "replaceUrl", "routerLink"] }, { kind: "pipe", type: i2$1.TranslatePipe, name: "cxTranslate" }, { kind: "pipe", type: i2$1.UrlPipe, name: "cxUrl" }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ConfiguratorTextfieldAddToCartButtonComponent, decorators: [{
            type: Component,
...
ConfiguratorTextfieldInputFieldComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ConfiguratorTextfieldInputFieldComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
ConfiguratorTextfieldInputFieldComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.2.3", type: ConfiguratorTextfieldInputFieldComponent, selector: "cx-configurator-textfield-input-field", inputs: { attribute: "attribute" }, outputs: { inputChange: "inputChange" }, ngImport: i0, template: "<label\n  id=\"{{ getIdLabel(attribute) }}\"\n  class=\"cx-configurator-textfield-label\"\n  [attr.aria-label]=\"'configurator.a11y.nameOfAttribute' | cxTranslate\"\n  >{{ attribute.configurationLabel }}</label\n>\n<div class=\"form-group\">\n  <input\n    [formControl]=\"attributeInputForm\"\n    class=\"form-control\"\n    (change)=\"onInputChange()\"\n    [attr.aria-label]=\"\n      'configurator.a11y.valueOfAttributeFull'\n        | cxTranslate\n          : {\n              value: attribute.configurationValue,\n              attribute: attribute.configurationLabel\n            }\n    \"\n  />\n</div>\n", dependencies: [{ kind: "directive", type: i1$1.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { kind: "directive", type: i1$1.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i1$1.FormControlDirective, selector: "[formControl]", inputs: ["formControl", "disabled", "ngModel"], outputs: ["ngModelChange"], exportAs: ["ngForm"] }, { kind: "pipe", type: i2$1.TranslatePipe, name: "cxTranslate" }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ConfiguratorTextfieldInputFieldComponent, decorators: [{
            type: Component,
...
ConfiguratorTextfieldFormComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ConfiguratorTextfieldFormComponent, deps: [{ token: ConfiguratorTextfieldService }, { token: i3.ConfiguratorRouterExtractorService }], target: i0.ɵɵFactoryTarget.Component });
...
TextfieldConfiguratorComponentsModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorComponentsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
TextfieldConfiguratorComponentsModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorComponentsModule, declarations: [ConfiguratorTextfieldFormComponent,
...
TextfieldConfiguratorComponentsModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorComponentsModule, providers: [
        ...
        I18nModule,
        UrlModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorComponentsModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        RouterModule,
...
ConfiguratorTextfieldConnector.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ConfiguratorTextfieldConnector, deps: [{ token: ConfiguratorTextfieldAdapter }], target: i0.ɵɵFactoryTarget.Injectable });
...
class ConfiguratorTextfieldEffects {
    constructor(actions$, configuratorTextfieldConnector) {
        ...
        this.createConfiguration$ = createEffect(() => this.actions$.pipe(ofType(CREATE_CONFIGURATION), map((action) => action.payload), switchMap((payload) => {
            ...
            }), catchError((error) => of(new CreateConfigurationFail(normalizeHttpError(error)))));
        })));
        this.addToCart$ = createEffect(() => this.actions$.pipe(ofType(ADD_TO_CART), map((action) => action.payload), switchMap((payload) => {
            ...
            }), catchError((error) => of(new AddToCartFail(normalizeHttpError(error)))));
        })));
        this.updateCartEntry$ = createEffect(() => this.actions$.pipe(ofType(UPDATE_CART_ENTRY_CONFIGURATION), map((action) => action.payload), switchMap((payload) => {
            ...
            }), catchError((error) => of(new UpdateCartEntryConfigurationFail(normalizeHttpError(error)))));
        })));
        this.readConfigurationForCartEntry$ = createEffect(() => this.actions$.pipe(ofType(READ_CART_ENTRY_CONFIGURATION), switchMap((action) => {
            ...
            return this.configuratorTextfieldConnector
                ...
                new ReadCartEntryConfigurationFail(normalizeHttpError(error)),
            ]));
        })));
        this.readConfigurationForOrderEntry$ = createEffect(() => this.actions$.pipe(ofType(READ_ORDER_ENTRY_CONFIGURATION), switchMap((action) => {
            ...
            return this.configuratorTextfieldConnector
                ...
                new ReadOrderEntryConfigurationFail(normalizeHttpError(error)),
            ]));
        })));
    }
}
ConfiguratorTextfieldEffects.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ConfiguratorTextfieldEffects, deps: [{ token: i1$2.Actions }, { token: ConfiguratorTextfieldConnector }], target: i0.ɵɵFactoryTarget.Injectable });
...
ConfiguratorTextfieldStoreModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ConfiguratorTextfieldStoreModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
ConfiguratorTextfieldStoreModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.3", ngImport: i0, type: ConfiguratorTextfieldStoreModule, imports: [CommonModule,
        StateModule, i1.StoreFeatureModule, i1$2.EffectsFeatureModule] });
ConfiguratorTextfieldStoreModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ConfiguratorTextfieldStoreModule, providers: [configuratorTextfieldReducerProvider], imports: [CommonModule,
        StateModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ConfiguratorTextfieldStoreModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
TextfieldConfiguratorCoreModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorCoreModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
TextfieldConfiguratorCoreModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorCoreModule, imports: [ConfiguratorTextfieldStoreModule] });
TextfieldConfiguratorCoreModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorCoreModule, providers: [ConfiguratorTextfieldConnector], imports: [ConfiguratorTextfieldStoreModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorCoreModule, decorators: [{
            type: NgModule,
            args: [{
...
OccConfiguratorTextfieldAddToCartSerializer.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: OccConfiguratorTextfieldAddToCartSerializer, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
OccConfiguratorTextfieldAddToCartSerializer.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: OccConfiguratorTextfieldAddToCartSerializer, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: OccConfiguratorTextfieldAddToCartSerializer, decorators: [{
            type: Injectable,
...
OccConfiguratorTextfieldNormalizer.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: OccConfiguratorTextfieldNormalizer, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
OccConfiguratorTextfieldNormalizer.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: OccConfiguratorTextfieldNormalizer, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: OccConfiguratorTextfieldNormalizer, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'root' }]
        }], ctorParameters: function () { return []; } });
...
OccConfiguratorTextfieldAdapter.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: OccConfiguratorTextfieldAdapter, deps: [{ token: i1$3.HttpClient }, { token: i2$1.OccEndpointsService }, { token: i2$1.ConverterService }], target: i0.ɵɵFactoryTarget.Injectable });
...
OccConfiguratorTextfieldUpdateCartEntrySerializer.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: OccConfiguratorTextfieldUpdateCartEntrySerializer, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
OccConfiguratorTextfieldUpdateCartEntrySerializer.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: OccConfiguratorTextfieldUpdateCartEntrySerializer, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: OccConfiguratorTextfieldUpdateCartEntrySerializer, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'root' }]
        }], ctorParameters: function () { return []; } });
...
TextfieldConfiguratorOccModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorOccModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
TextfieldConfiguratorOccModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorOccModule, imports: [CommonModule, i2$1.ConfigModule] });
TextfieldConfiguratorOccModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorOccModule, providers: [
        {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorOccModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
TextfieldConfiguratorModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
TextfieldConfiguratorModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorModule, imports: [TextfieldConfiguratorCoreModule,
        TextfieldConfiguratorComponentsModule,
        TextfieldConfiguratorOccModule] });
TextfieldConfiguratorModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorModule, imports: [TextfieldConfiguratorCoreModule,
        TextfieldConfiguratorComponentsModule,
        TextfieldConfiguratorOccModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TextfieldConfiguratorModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
