...
class CpqConfiguratorNormalizer {
    ...
    generateTotalNumberOfIssues(source) {
        ...
        let numberOfIssues = ((_b = (_a = source.incompleteAttributes) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) +
    ...
    setSelectedSingleValue(attribute) {
        var _a;
        const selectedValues = (_a = attribute.values) === null || _a === void 0 ? void 0 : _a.map((entry) => entry).filter((entry) => entry.selected);
        if (selectedValues && selectedValues.length === 1) {
            attribute.selectedSingleValue = selectedValues[0].valueCode;
        }
    }
    convertValueDisplay(sourceValue, sourceAttribute, value) {
        (sourceAttribute === null || sourceAttribute === void 0 ? void 0 : sourceAttribute.displayAs) === Cpq.DisplayAs.DROPDOWN &&
            (sourceValue === null || sourceValue === void 0 ? void 0 : sourceValue.selected) &&
    ...
    convertAttributeType(sourceAttribute) {
        ...
        const displayAsProduct = (sourceAttribute === null || sourceAttribute === void 0 ? void 0 : sourceAttribute.values) &&
            this.cpqConfiguratorNormalizerUtilsService.hasAnyProducts(sourceAttribute === null || sourceAttribute === void 0 ? void 0 : sourceAttribute.values)
            ? true
            : false;
        ...
        switch (displayAs) {
            ...
            case Cpq.DisplayAs.INPUT: {
                if ((sourceAttribute === null || sourceAttribute === void 0 ? void 0 : sourceAttribute.dataType) === Cpq.DataType.INPUT_STRING) {
                    uiType = Configurator.UiType.STRING;
                }
                else {
                    uiType = Configurator.UiType.NOT_IMPLEMENTED;
