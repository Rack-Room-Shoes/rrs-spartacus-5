...
class ConfiguratorCommonsService {
    ...
    hasConflicts(owner) {
        return this.getConfiguration(owner).pipe(map((configuration) => {
            ...
            return ((_a = configuration.groups[0]) === null || _a === void 0 ? void 0 : _a.groupType) ===
...
class ConfiguratorGroupsService {
    ...
    getCurrentGroupId(owner) {
        return this.configuratorCommonsService.getConfiguration(owner).pipe(map((configuration) => {
            var _a;
            if (configuration === null || configuration === void 0 ? void 0 : configuration.interactionState.currentGroup) {
                return configuration.interactionState.currentGroup;
            }
            else {
                return (_a = configuration === null || configuration === void 0 ? void 0 : configuration.groups[0]) === null || _a === void 0 ? void 0 : _a.id;
            }
        }));
    }
    /**
    ...
    getNeighboringGroupId(owner, neighboringIndex) {
        return this.getCurrentGroupId(owner).pipe(switchMap((currentGroupId) => {
            return this.configuratorCommonsService.getConfiguration(owner).pipe(map((configuration) => {
                let nextGroup;
                configuration === null || configuration === void 0 ? void 0 : configuration.flatGroups.forEach((group, index) => {
                    if (group.id === currentGroupId &&
                        (configuration === null || configuration === void 0 ? void 0 : configuration.flatGroups) &&
                        (configuration === null || configuration === void 0 ? void 0 : configuration.flatGroups[index + neighboringIndex]) //Check if neighboring group exists
                    ) {
                        nextGroup =
                            configuration === null || configuration === void 0 ? void 0 : configuration.flatGroups[index + neighboringIndex].id;
                    }
                });
                return nextGroup;
            }), take(1));
...
class ConfiguratorAddToCartButtonComponent {
    ...
    extractConfigPrices(configuration) {
        ...
        let basePrice = (_a = priceSummary === null || priceSummary === void 0 ? void 0 : priceSummary.basePrice) === null || _a === void 0 ? void 0 : _a.formattedValue;
        let selectedOptions = (_b = priceSummary === null || priceSummary === void 0 ? void 0 : priceSummary.selectedOptions) === null || _b === void 0 ? void 0 : _b.formattedValue;
        let totalPrice = (_c = priceSummary === null || priceSummary === void 0 ? void 0 : priceSummary.currentTotal) === null || _c === void 0 ? void 0 : _c.formattedValue;
        let prices = {
            basePrice: basePrice,
...
function configuratorReducer(state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case GET_CONFIGURATION_OVERVIEW_SUCCESS: {
            ...
            const result = Object.assign(Object.assign({}, state), { overview: content, priceSummary: content.priceSummary, interactionState: Object.assign(Object.assign({}, state.interactionState), { issueNavigationDone: false }) });
            return result;
        }
        ...
        case SET_CURRENT_GROUP: {
            ...
            return Object.assign(Object.assign({}, state), { interactionState: Object.assign(Object.assign({}, state.interactionState), { currentGroup: newCurrentGroup }) });
        }
...
function setInitialCurrentGroup(state) {
    ...
    if (flatGroups && flatGroups.length > 0) {
        initialCurrentGroup = (_a = flatGroups[0]) === null || _a === void 0 ? void 0 : _a.id;
    }
    const result = Object.assign(Object.assign({}, state), { interactionState: Object.assign(Object.assign({}, state.interactionState), { currentGroup: initialCurrentGroup }) });
    return result;
}
...
class ConfiguratorAttributeHeaderComponent extends ConfiguratorAttributeBaseComponent {
    ...
    isRequiredAttributeWithDomain() {
        var _a;
        const uiType = this.attribute.uiType;
        return ((_a = (this.attribute.required &&
            this.attribute.incomplete &&
            uiType !== Configurator.UiType.NOT_IMPLEMENTED &&
            uiType !== Configurator.UiType.STRING &&
            uiType !== Configurator.UiType.NUMERIC)) !== null && _a !== void 0 ? _a : false);
    }
    /**
    ...
    isNavigationToConflictEnabled() {
        var _a, _b;
        return ((_b = (_a = this.configuratorUiSettings.productConfigurator) === null || _a === void 0 ? void 0 : _a.enableNavigationToConflict) !== null && _b !== void 0 ? _b : false);
    }
}
...
class ConfiguratorAttributeQuantityComponent {
    ...
    subscribeToQuantityChange() {
        return this.quantity.valueChanges
            .pipe(debounce(() => { var _a, _b; return timer((_b = (_a = this.config.productConfigurator) === null || _a === void 0 ? void 0 : _a.updateDebounceTime) === null || _b === void 0 ? void 0 : _b.quantity); }), take(1))
...
class ConfiguratorPriceComponent {
    ...
    get price() {
        ...
        if (this.formula.priceTotal) {
            ...
            return '+ ' + ((_a = this.formula.price) === null || _a === void 0 ? void 0 : _a.formattedValue);
        }
    }
    /**
    ...
    get priceTotal() {
        var _a;
        return '+ ' + ((_a = this.formula.priceTotal) === null || _a === void 0 ? void 0 : _a.formattedValue);
    }
    /**
...
class ConfiguratorAttributeSingleSelectionBaseComponent extends ConfiguratorAttributeBaseComponent {
    ...
    onSelect(value) {
        this.loading$.next(true);
        const event = {
            changedAttribute: Object.assign(Object.assign({}, this.attribute), { selectedSingleValue: value }),
    ...
    onHandleQuantity(quantity) {
        this.loading$.next(true);
        const event = {
            changedAttribute: Object.assign(Object.assign({}, this.attribute), { quantity }),
            ownerKey: this.ownerKey,
...
class ConfiguratorAttributeCheckBoxListComponent extends ConfiguratorAttributeMultiSelectionBaseComponent {
    ...
    onSelect() {
        ...
        const event = {
            changedAttribute: Object.assign(Object.assign({}, this.attribute), { values: selectedValues }),
            ownerKey: this.ownerKey,
            updateType: Configurator.UpdateType.ATTRIBUTE,
        };
        this.selectionChange.emit(event);
...
class ConfiguratorAttributeInputFieldComponent extends ConfiguratorAttributeBaseComponent {
    ...
    onChange() {
        const event = {
            ownerKey: this.ownerKey,
            changedAttribute: Object.assign(Object.assign({}, this.attribute), { userInput: this.attributeInputForm.value }),
        };
    ...
    get isRequired() {
        ...
        return isNonDomainAttributeType ? (_a = this.attribute.required) !== null && _a !== void 0 ? _a : false : false;
    }
}
...
class ConfiguratorAttributeMultiSelectionBundleComponent extends ConfiguratorAttributeMultiSelectionBaseComponent {
    ...
    onDeselectAll() {
        this.loading$.next(true);
        const event = {
            changedAttribute: Object.assign(Object.assign({}, this.attribute), { values: [] }),
            ownerKey: this.ownerKey,
            updateType: Configurator.UpdateType.ATTRIBUTE,
        };
        this.selectionChange.emit(event);
...
class ConfiguratorConflictSuggestionComponent {
    ...
    displayConflictSuggestion(group) {
        ...
        return group.groupType === Configurator.GroupType.CONFLICT_GROUP &&
            group.attributes
            ? ((_a = group.attributes) === null || _a === void 0 ? void 0 : _a.length) > 1
            : false;
    }
...
class ConfiguratorOverviewFormComponent {
    ...
    hasAttributes(configuration) {
        var _a, _b;
        return (((_b = (_a = configuration.overview) === null || _a === void 0 ? void 0 : _a.groups) === null || _b === void 0 ? void 0 : _b.find((group) => group.attributes ? group.attributes.length : 0 > 0)) !== undefined);
    }
    /**
...
class OccConfiguratorVariantNormalizer {
    ...
    convert(source, target) {
        ...
        const flatGroups = [];
        (_c = source.groups) === null || _c === void 0 ? void 0 : _c.forEach((group) => this.convertGroup(group, resultTarget.groups, flatGroups));
...
class VariantConfiguratorOccAdapter {
    ...
    readConfiguration(configId, groupId, configurationOwner) {
        return this.http
            ...
            .pipe(this.converterService.pipeable(VARIANT_CONFIGURATOR_NORMALIZER), map((resultConfiguration) => {
            return Object.assign(Object.assign({}, resultConfiguration), { owner: configurationOwner });
        }));
    }
    updateConfiguration(configuration) {
        const configId = configuration.configId;
