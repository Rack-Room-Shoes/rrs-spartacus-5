...
export declare type ConfiguratorActions = CreateConfiguration | CreateConfigurationFail | CreateConfigurationSuccess | UpdateConfiguration | ReadCartEntryConfigurationFail | ReadCartEntryConfigurationSuccess | ReadCartEntryConfiguration | ReadOrderEntryConfigurationFail | ReadOrderEntryConfigurationSuccess | ReadOrderEntryConfiguration | UpdateCartEntryConfiguration | RemoveConfiguration;
