...
export declare class ConfiguratorTextfieldAddToCartButtonComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ConfiguratorTextfieldAddToCartButtonComponent, "cx-configurator-textfield-add-to-cart-button", never, { "configuration": "configuration"; "productCode": "productCode"; }, {}, never, never, false>;
}
