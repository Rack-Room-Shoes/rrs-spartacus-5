...
export declare class ConfiguratorTextfieldInputFieldComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ConfiguratorTextfieldInputFieldComponent, "cx-configurator-textfield-input-field", never, { "attribute": "attribute"; }, { "inputChange": "inputChange"; }, never, never, false>;
}
