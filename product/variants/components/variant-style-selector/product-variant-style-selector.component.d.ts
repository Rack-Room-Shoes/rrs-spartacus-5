...
export declare class ProductVariantStyleSelectorComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProductVariantStyleSelectorComponent, "cx-product-variant-style-selector", never, { "variants": "variants"; }, {}, never, never, false>;
}
