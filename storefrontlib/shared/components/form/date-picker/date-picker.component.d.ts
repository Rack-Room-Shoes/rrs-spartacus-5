...
export declare class DatePickerComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DatePickerComponent, "cx-date-picker", never, { "control": "control"; "min": "min"; "max": "max"; "required": "required"; }, { "update": "update"; }, never, never, false>;
}
