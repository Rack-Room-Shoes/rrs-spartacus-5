...
export declare class FormErrorsComponent implements DoCheck {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FormErrorsComponent, "cx-form-errors", never, { "prefix": "prefix"; "translationParams": "translationParams"; "control": "control"; }, {}, never, never, false>;
}
