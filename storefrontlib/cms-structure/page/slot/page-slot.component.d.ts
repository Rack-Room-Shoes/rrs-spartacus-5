...
export declare class PageSlotComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PageSlotComponent, "cx-page-slot,[cx-page-slot]", never, { "position": "position"; "class": "class"; "isPageFold": "isPageFold"; "hasComponents": "hasComponents"; }, {}, never, never, false>;
}
