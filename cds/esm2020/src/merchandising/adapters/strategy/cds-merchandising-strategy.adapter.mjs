...
CdsMerchandisingStrategyAdapter.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsMerchandisingStrategyAdapter, deps: [{ token: i1.CdsEndpointsService }, { token: i2.HttpClient }], target: i0.ɵɵFactoryTarget.Injectable });
