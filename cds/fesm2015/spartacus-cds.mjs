...
import { Injectable, Directive, Input, NgModule, PLATFORM_ID, Inject, Component, ChangeDetectionStrategy, APP_INITIALIZER } from '@angular/core';
import * as i1 from '@spartacus/core';
import { Config, isNotUndefined, AuthActions, provideDefaultConfig, DeferLoadingStrategy, PageType, UrlModule, provideConfigValidator } from '@spartacus/core';
...
import { of, merge, fromEvent, combineLatest, EMPTY, using } from 'rxjs';
import { switchMapTo, map, shareReplay, filter, distinctUntilChanged, tap, mapTo, switchMap, withLatestFrom, startWith, pairwise, distinctUntilKeyChanged, debounceTime, mergeMap, take } from 'rxjs/operators';
import * as i3 from '@ngrx/store';
import * as i3$1 from '@spartacus/cart/base/root';
import { CartPageEvent, CartAddEntrySuccessEvent, CartRemoveEntrySuccessEvent, CartUpdateEntrySuccessEvent } from '@spartacus/cart/base/root';
...
CdsConfig.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsConfig, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
CdsConfig.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsConfig, providedIn: 'root', useExisting: Config });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsConfig, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                    useExisting: Config,
...
CdsEndpointsService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsEndpointsService, deps: [{ token: CdsConfig }], target: i0.ɵɵFactoryTarget.Injectable });
CdsEndpointsService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsEndpointsService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsEndpointsService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
CdsMerchandisingStrategyAdapter.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsMerchandisingStrategyAdapter, deps: [{ token: CdsEndpointsService }, { token: i2.HttpClient }], target: i0.ɵɵFactoryTarget.Injectable });
CdsMerchandisingStrategyAdapter.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsMerchandisingStrategyAdapter });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsMerchandisingStrategyAdapter, decorators: [{
            type: Injectable
...
AttributesDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: AttributesDirective, deps: [{ token: i0.Renderer2 }, { token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
AttributesDirective.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "14.2.3", type: AttributesDirective, selector: "[cxAttributes]", inputs: { cxAttributes: "cxAttributes", cxAttributesNamePrefix: "cxAttributesNamePrefix" }, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: AttributesDirective, decorators: [{
            type: Directive,
            args: [{
...
AttributesModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: AttributesModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
AttributesModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.3", ngImport: i0, type: AttributesModule, declarations: [AttributesDirective], imports: [CommonModule], exports: [AttributesDirective] });
AttributesModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: AttributesModule, imports: [CommonModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: AttributesModule, decorators: [{
            type: NgModule,
            args: [{
...
MerchandisingStrategyConnector.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: MerchandisingStrategyConnector, deps: [{ token: MerchandisingStrategyAdapter }], target: i0.ɵɵFactoryTarget.Injectable });
MerchandisingStrategyConnector.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: MerchandisingStrategyConnector, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: MerchandisingStrategyConnector, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
OccBackendNotification.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: OccBackendNotification, deps: [{ token: i2.HttpClient }, { token: i1.OccEndpointsService }], target: i0.ɵɵFactoryTarget.Injectable });
...
ProfileTagEventService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ProfileTagEventService, deps: [{ token: i1.WindowRef }, { token: CdsConfig }, { token: i1.BaseSiteService }, { token: PLATFORM_ID }], target: i0.ɵɵFactoryTarget.Injectable });
...
CdsBackendConnector.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsBackendConnector, deps: [{ token: CdsBackendNotificationAdapter }], target: i0.ɵɵFactoryTarget.Injectable });
CdsBackendConnector.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsBackendConnector, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsBackendConnector, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
ProfileTagLifecycleService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ProfileTagLifecycleService, deps: [{ token: i1.ConsentService }, { token: CdsConfig }, { token: i3.ActionsSubject }], target: i0.ɵɵFactoryTarget.Injectable });
...
ProfileTagInjectorService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ProfileTagInjectorService, deps: [{ token: ProfileTagEventService }, { token: CdsBackendConnector }, { token: ProfileTagLifecycleService }], target: i0.ɵɵFactoryTarget.Injectable });
...
ProfileTagComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ProfileTagComponent, deps: [{ token: ProfileTagInjectorService }], target: i0.ɵɵFactoryTarget.Component });
ProfileTagComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.2.3", type: ProfileTagComponent, selector: "cx-profiletag", ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ProfileTagComponent, decorators: [{
            type: Component,
            args: [{
...
ProfileTagCmsModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ProfileTagCmsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
ProfileTagCmsModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.3", ngImport: i0, type: ProfileTagCmsModule, declarations: [ProfileTagComponent], imports: [CommonModule], exports: [ProfileTagComponent] });
ProfileTagCmsModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ProfileTagCmsModule, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ProfileTagCmsModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [CommonModule],
                    providers: [
...
ConsentReferenceInterceptor.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ConsentReferenceInterceptor, deps: [{ token: ProfileTagEventService }, { token: i1.OccEndpointsService }], target: i0.ɵɵFactoryTarget.Injectable });
...
DebugInterceptor.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: DebugInterceptor, deps: [{ token: ProfileTagEventService }, { token: i1.OccEndpointsService }], target: i0.ɵɵFactoryTarget.Injectable });
DebugInterceptor.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: DebugInterceptor, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: DebugInterceptor, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'root' }]
        }], ctorParameters: function () { return [{ type: ProfileTagEventService }, { type: i1.OccEndpointsService }]; } });
...
ProfileTagModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ProfileTagModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
ProfileTagModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.3", ngImport: i0, type: ProfileTagModule, imports: [ProfileTagCmsModule] });
ProfileTagModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ProfileTagModule, providers: [
        {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ProfileTagModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [ProfileTagCmsModule],
                    providers: [
...
ProfileTagPushEventsService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: ProfileTagPushEventsService, deps: [{ token: i1.EventService }, { token: i2$2.PersonalizationContextService }, { token: i3$1.ActiveCartFacade }], target: i0.ɵɵFactoryTarget.Injectable });
...
TrackingService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TrackingService, deps: [{ token: ProfileTagLifecycleService }, { token: ProfileTagPushEventsService }, { token: ProfileTagEventService }], target: i0.ɵɵFactoryTarget.Injectable });
...
TrackingModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TrackingModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
TrackingModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.3", ngImport: i0, type: TrackingModule });
TrackingModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TrackingModule, providers: [
        {
            multi: true,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: TrackingModule, decorators: [{
            type: NgModule,
            args: [{
                    providers: [
                        {
...
CdsMerchandisingUserContextService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsMerchandisingUserContextService, deps: [{ token: i1.RoutingService }, { token: i1.ProductSearchService }, { token: ProfileTagEventService }, { token: ProfileTagLifecycleService }, { token: i1$1.FacetService }], target: i0.ɵɵFactoryTarget.Injectable });
CdsMerchandisingUserContextService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsMerchandisingUserContextService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsMerchandisingUserContextService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
CdsMerchandisingSiteContextService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsMerchandisingSiteContextService, deps: [{ token: i1.BaseSiteService }, { token: i1.LanguageService }], target: i0.ɵɵFactoryTarget.Injectable });
CdsMerchandisingSiteContextService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsMerchandisingSiteContextService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsMerchandisingSiteContextService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
CdsMerchandisingProductService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsMerchandisingProductService, deps: [{ token: MerchandisingStrategyConnector }, { token: CdsMerchandisingUserContextService }, { token: CdsMerchandisingSiteContextService }], target: i0.ɵɵFactoryTarget.Injectable });
CdsMerchandisingProductService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsMerchandisingProductService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsMerchandisingProductService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class MerchandisingCarouselComponentService {
    ...
    sendCarouselItemClickedEvent(merchandisingCarouselModel, clickedProduct) {
        ...
        this.profileTagEventService.notifyProfileTagOfEventOccurence(new MerchandisingCarouselClickedEvent(carouselEvent, clickedProduct.metadata.slot, clickedProduct.code, (_b = (_a = clickedProduct.images) === null || _a === void 0 ? void 0 : _a.PRIMARY['product']) === null || _b === void 0 ? void 0 : _b.url));
    }
    ...
    mapStrategyProductsToCarouselItems(strategyProducts) {
        return strategyProducts && strategyProducts.products
            ? strategyProducts.products.map((strategyProduct, index) => this.productService.get(strategyProduct.id, this.PRODUCT_SCOPE).pipe(map((product) => (Object.assign(Object.assign({}, product), { metadata: this.getCarouselItemMetadata(strategyProduct, index + 1) })))))
            : [EMPTY];
    }
...
MerchandisingCarouselComponentService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: MerchandisingCarouselComponentService, deps: [{ token: CdsMerchandisingProductService }, { token: i1.ProductService }, { token: ProfileTagEventService }, { token: CdsConfig }], target: i0.ɵɵFactoryTarget.Injectable });
...
MerchandisingCarouselCmsModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: MerchandisingCarouselCmsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
MerchandisingCarouselCmsModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.3", ngImport: i0, type: MerchandisingCarouselCmsModule, declarations: [MerchandisingCarouselComponent], imports: [CommonModule,
        AttributesModule,
        CarouselModule,
        MediaModule,
        RouterModule,
        UrlModule], exports: [MerchandisingCarouselComponent] });
MerchandisingCarouselCmsModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: MerchandisingCarouselCmsModule, providers: [
        provideDefaultConfig({
            cmsComponents: {
        ...
        RouterModule,
        UrlModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: MerchandisingCarouselCmsModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
MerchandisingModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: MerchandisingModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
MerchandisingModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.3", ngImport: i0, type: MerchandisingModule, imports: [MerchandisingCarouselCmsModule] });
MerchandisingModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: MerchandisingModule, providers: [
        {
            provide: MerchandisingStrategyAdapter,
            useClass: CdsMerchandisingStrategyAdapter,
        },
    ], imports: [MerchandisingCarouselCmsModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: MerchandisingModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [MerchandisingCarouselCmsModule],
                    providers: [
...
CdsModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
CdsModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.3", ngImport: i0, type: CdsModule, imports: [ProfileTagModule, TrackingModule, MerchandisingModule] });
CdsModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsModule, imports: [ProfileTagModule, TrackingModule, MerchandisingModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CdsModule, decorators: [{
            type: NgModule,
            args: [{
