...
AnonymousConsentsService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: AnonymousConsentsService, deps: [{ token: i1.Store }, { token: i2.AuthService }], target: i0.ɵɵFactoryTarget.Injectable });
