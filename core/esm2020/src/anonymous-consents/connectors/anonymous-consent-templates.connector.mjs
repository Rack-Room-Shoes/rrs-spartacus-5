...
AnonymousConsentTemplatesConnector.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: AnonymousConsentTemplatesConnector, deps: [{ token: i1.AnonymousConsentTemplatesAdapter }], target: i0.ɵɵFactoryTarget.Injectable });
