...
export declare class CheckoutDeliveryAddressComponent implements OnInit {
    ...
    ngOnInit(): void;
    getCardContent(address: Address, selected: any, textDefaultDeliveryAddress: string, textShipToThisAddress: string, textSelected: string): Card;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CheckoutDeliveryAddressComponent, "cx-delivery-address", never, {}, {}, never, never, false>;
}
