...
import { ActiveCartFacade, CartItemComponentOptions, CartUiEventAddToCart } from '@spartacus/cart/base/root';
...
export declare class AddToCartComponent implements OnInit, OnDestroy {
    ...
    addToCart(): void;
    protected createCartUiEventAddToCart(productCode: string, quantity: number, numberOfEntriesBeforeAdd: number): CartUiEventAddToCart;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<AddToCartComponent, [null, null, null, null, null, { optional: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<AddToCartComponent, "cx-add-to-cart", never, { "productCode": "productCode"; "showQuantity": "showQuantity"; "options": "options"; "product": "product"; }, {}, never, never, false>;
}
