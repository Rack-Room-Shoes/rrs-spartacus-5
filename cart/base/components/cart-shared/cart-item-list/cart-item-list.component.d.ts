...
import { ActiveCartFacade, CartItemComponentOptions, MultiCartFacade, OrderEntry, PromotionLocation, SelectiveCartFacade } from '@spartacus/cart/base/root';
...
export declare class CartItemListComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CartItemListComponent, "cx-cart-item-list", never, { "readonly": "readonly"; "hasHeader": "hasHeader"; "options": "options"; "cartId": "cartId"; "items": "items"; "promotionLocation": "promotionLocation"; "setLoading": "cartIsLoading"; }, {}, never, never, false>;
}
export {};
