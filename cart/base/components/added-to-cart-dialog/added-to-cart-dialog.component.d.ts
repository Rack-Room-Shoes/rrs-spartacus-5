...
export declare class AddedToCartDialogComponent implements OnInit, OnDestroy {
    ...
    init(productCode: string, quantity: number, numberOfEntriesBeforeAdd: number): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AddedToCartDialogComponent, "cx-added-to-cart-dialog", never, {}, {}, never, never, false>;
}
