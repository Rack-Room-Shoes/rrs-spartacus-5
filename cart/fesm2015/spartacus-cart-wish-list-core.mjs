...
WishListService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: WishListService, deps: [{ token: i1.Store }, { token: i2.UserAccountFacade }, { token: i3.MultiCartFacade }, { token: i4.UserIdService }], target: i0.ɵɵFactoryTarget.Injectable });
WishListService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: WishListService });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: WishListService, decorators: [{
            type: Injectable
...
class WishListEffects {
    constructor(actions$, cartConnector, userIdService, store) {
        ...
        this.setWishListId$ = this.actions$.pipe(ofType(CREATE_WISH_LIST_SUCCESS, LOAD_WISH_LIST_SUCCESS), map((action) => {
            switch (action.type) {
        ...
        this.setWishListData$ = this.actions$.pipe(ofType(CREATE_WISH_LIST_SUCCESS, LOAD_WISH_LIST_SUCCESS), map((action) => {
            switch (action.type) {
                case CREATE_WISH_LIST_SUCCESS:
                case LOAD_WISH_LIST_SUCCESS: {
...
WishListEffects.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: WishListEffects, deps: [{ token: i1$1.Actions }, { token: i2$1.CartConnector }, { token: i4.UserIdService }, { token: i1.Store }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: WishListEffects, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: i1$1.Actions }, { type: i2$1.CartConnector }, { type: i4.UserIdService }, { type: i1.Store }]; }, propDecorators: { createWishList$: [], loadWishList$: [], resetWishList$: [], setWishListId$: [], setWishListData$: [] } });
...
WishListStoreModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: WishListStoreModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
WishListStoreModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.3", ngImport: i0, type: WishListStoreModule, imports: [i1$1.EffectsFeatureModule] });
WishListStoreModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: WishListStoreModule, imports: [EffectsModule.forFeature(effects)] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: WishListStoreModule, decorators: [{
            type: NgModule,
            args: [{
...
WishListCoreModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: WishListCoreModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
WishListCoreModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.3", ngImport: i0, type: WishListCoreModule, imports: [WishListStoreModule] });
WishListCoreModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: WishListCoreModule, providers: [...facadeProviders], imports: [WishListStoreModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: WishListCoreModule, decorators: [{
            type: NgModule,
            args: [{
