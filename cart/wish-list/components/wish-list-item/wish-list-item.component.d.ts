...
export declare class WishListItemComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<WishListItemComponent, "[cx-wish-list-item], cx-wish-list-item", never, { "isLoading": "isLoading"; "cartEntry": "cartEntry"; }, { "remove": "remove"; }, never, never, false>;
}
