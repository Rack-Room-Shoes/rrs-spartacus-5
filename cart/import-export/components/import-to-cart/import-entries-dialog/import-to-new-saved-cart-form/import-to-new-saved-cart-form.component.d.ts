...
export declare class ImportToNewSavedCartFormComponent extends ImportEntriesFormComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ImportToNewSavedCartFormComponent, "cx-import-to-new-saved-cart-form", never, {}, { "submitEvent": "submitEvent"; }, never, never, false>;
}
