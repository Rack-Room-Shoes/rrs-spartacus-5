...
export declare class QuickOrderItemComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<QuickOrderItemComponent, "[cx-quick-order-item], cx-quick-order-item", never, { "entry": "entry"; "index": "index"; "loading": "loading"; }, {}, never, never, false>;
}
