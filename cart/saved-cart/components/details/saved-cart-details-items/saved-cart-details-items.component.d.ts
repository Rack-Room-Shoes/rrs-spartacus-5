...
import { Cart, CartOutlets, PromotionLocation } from '@spartacus/cart/base/root';
...
export declare class SavedCartDetailsItemsComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SavedCartDetailsItemsComponent, "cx-saved-cart-details-items", never, {}, {}, never, never, false>;
}
