...
SceneConnector.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: SceneConnector, deps: [{ token: SceneAdapter }], target: i0.ɵɵFactoryTarget.Injectable });
...
VisualizationConnector.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: VisualizationConnector, deps: [{ token: VisualizationAdapter }], target: i0.ɵɵFactoryTarget.Injectable });
...
SceneNodeToProductLookupService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: SceneNodeToProductLookupService, deps: [{ token: i1.EpdVisualizationConfig }, { token: SceneConnector }], target: i0.ɵɵFactoryTarget.Injectable });
...
VisualizationLookupService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: VisualizationLookupService, deps: [{ token: i1.EpdVisualizationConfig }, { token: VisualizationConnector }], target: i0.ɵɵFactoryTarget.Injectable });
VisualizationLookupService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: VisualizationLookupService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: VisualizationLookupService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
EpdVisualizationCoreModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: EpdVisualizationCoreModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
EpdVisualizationCoreModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.3", ngImport: i0, type: EpdVisualizationCoreModule });
EpdVisualizationCoreModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: EpdVisualizationCoreModule, providers: [
        SceneConnector,
        VisualizationConnector,
        SceneNodeToProductLookupService,
        VisualizationLookupService,
    ] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: EpdVisualizationCoreModule, decorators: [{
            type: NgModule,
            args: [{
                    providers: [
                        SceneConnector,
