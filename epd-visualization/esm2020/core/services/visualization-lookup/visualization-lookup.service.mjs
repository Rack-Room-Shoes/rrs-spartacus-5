...
VisualizationLookupService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: VisualizationLookupService, deps: [{ token: i1.EpdVisualizationConfig }, { token: i2.VisualizationConnector }], target: i0.ɵɵFactoryTarget.Injectable });
