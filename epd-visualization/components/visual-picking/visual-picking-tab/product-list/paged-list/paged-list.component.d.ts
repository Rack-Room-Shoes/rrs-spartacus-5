...
export declare class PagedListComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PagedListComponent, "cx-epd-visualization-paged-list", never, { "title": "title"; "items": "items"; "headerTemplate": "headerTemplate"; "template": "template"; "itemsPerSlide": "itemsPerSlide"; "hideIndicators": "hideIndicators"; "indicatorIcon": "indicatorIcon"; "previousIcon": "previousIcon"; "nextIcon": "nextIcon"; "activeSlideStartIndex": "activeSlideStartIndex"; }, { "activeSlideStartIndexChange": "activeSlideStartIndexChange"; }, never, never, false>;
}
