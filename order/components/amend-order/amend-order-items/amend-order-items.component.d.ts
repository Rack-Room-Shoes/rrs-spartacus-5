...
export declare class CancelOrReturnItemsComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CancelOrReturnItemsComponent, "cx-amend-order-items", never, { "entries": "entries"; "isConfirmation": "isConfirmation"; }, {}, never, never, false>;
}
