...
export declare class FormComponent<T> implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FormComponent<any>, "cx-org-form", never, { "i18nRoot": "i18nRoot"; "animateBack": "animateBack"; "subtitle": "subtitle"; }, {}, never, ["[main]"], false>;
}
