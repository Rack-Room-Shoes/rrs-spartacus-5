...
export declare class SubListComponent extends ListComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SubListComponent, "cx-org-sub-list", never, { "previous": "previous"; "key": "key"; "showHint": "showHint"; "routerKey": "routerKey"; }, {}, never, ["[actions]", "[main]", "[info]"], false>;
}
