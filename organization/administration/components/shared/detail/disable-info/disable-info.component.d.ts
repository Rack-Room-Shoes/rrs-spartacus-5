...
export declare class DisableInfoComponent<T extends BaseItem> implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DisableInfoComponent<any>, "cx-org-disable-info", never, { "i18nRoot": "i18nRoot"; "displayInfoConfig": "displayInfoConfig"; "displayCustomInfo": "displayCustomInfo"; }, {}, never, ["*"], false>;
}
