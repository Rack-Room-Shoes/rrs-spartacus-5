...
export declare class ToggleStatusComponent<T extends BaseItem> implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ToggleStatusComponent<any>, "cx-org-toggle-status", never, { "i18nRoot": "i18nRoot"; "key": "key"; "disabled": "disabled"; }, {}, never, never, false>;
}
