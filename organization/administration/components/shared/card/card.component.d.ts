...
export declare class CardComponent<T extends BaseItem> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CardComponent<any>, "cx-org-card", never, { "i18nRoot": "i18nRoot"; "previous": "previous"; "subtitle": "subtitle"; "showHint": "showHint"; }, {}, never, ["[actions]", "[info]", "[main]"], false>;
}
