...
PermissionItemService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: PermissionItemService, deps: [{ token: i1.CurrentPermissionService }, { token: i2.RoutingService }, { token: i3.PermissionFormService }, { token: i4.PermissionService }], target: i0.ɵɵFactoryTarget.Injectable });
