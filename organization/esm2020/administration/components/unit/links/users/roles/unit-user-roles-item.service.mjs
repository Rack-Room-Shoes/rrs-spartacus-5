...
UnitUserRolesItemService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: UnitUserRolesItemService, deps: [{ token: i1.CurrentUnitUserService }, { token: i2.RoutingService }, { token: i3.UnitUserRolesFormService }, { token: i4.OrgUnitService }, { token: i4.B2BUserService }], target: i0.ɵɵFactoryTarget.Injectable });
