...
UnitListService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: UnitListService, deps: [{ token: i1.TableService }, { token: i2.OrgUnitService }, { token: i3.UnitItemService }, { token: i4.UnitTreeService }], target: i0.ɵɵFactoryTarget.Injectable });
