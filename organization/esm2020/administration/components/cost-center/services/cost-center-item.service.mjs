...
CostCenterItemService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.3", ngImport: i0, type: CostCenterItemService, deps: [{ token: i1.CurrentCostCenterService }, { token: i2.RoutingService }, { token: i3.CostCenterFormService }, { token: i4.CostCenterService }], target: i0.ɵɵFactoryTarget.Injectable });
